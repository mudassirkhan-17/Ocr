...
saves with consistent naming in nationwideop/ folder
...
Outputs:
    - nationwideop/{base_name}1.txt (Tesseract extraction)
    - nationwideop/{base_name}2.txt (PyMuPDF extraction)
    - nationwideop/{base_name}_combo.txt (auto-combined file)
"""
...
def main():
    ...
    if input_name is None:
        input_name = "westside_gl" #mudassir
