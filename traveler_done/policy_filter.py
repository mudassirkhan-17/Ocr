...
Outputs:
    - encovaop/{base_name}_fil1.txt (filtered Tesseract extraction)
    - encovaop/{base_name}_fil2.txt (filtered PyMuPDF extraction)
"""
...
class PolicyPageExtractor:
    ...
    def find_pages_with_dollar_amounts(self) -> List[int]:
        """Find pages that contain dollar amounts >= $200"""
