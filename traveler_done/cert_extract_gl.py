"""
Unified GL Certificate OCR + Extraction Pipeline
...
Usage:
    ...
    python cert_extract_gl.py encova/aaniya_gl.pdf
...
def main():
    ...
    """
    print("\n" + "="*80)
    print("UNIFIED GL CERTIFICATE OCR + EXTRACTION PIPELINE")
    print("="*80)
    print()
