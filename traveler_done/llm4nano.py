...
Examples:
  ...
  python llm4nano.py shelby
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="traveler_extraction_results.json",
    ...
    try:
        ...
        if output_file == "traveler_extraction_results.json":  # default value
